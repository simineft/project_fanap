...
const reducerFilterComedy=(state)=>{
  return {
    ...state,
   movies:state.all_movies.filter(item =>item.genre.name==="Comedy")
...
const reducerFilterAction=(state)=>{
    return{
      ...state,
       movies:state.all_movies.filter(item =>item.genre.name==="Action")
   }
}
...
const reducerFilterThriller=(state)=>{
  return{
    ...state,
     movies:state.all_movies.filter(item =>item.genre.name==="Thriller")
}
}
